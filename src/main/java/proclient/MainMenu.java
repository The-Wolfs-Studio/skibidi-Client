...
public class MainMenu extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, this.height / 2 - 30, "ForkonGithub"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        mc.getTextureManager().bindTexture(new ResourceLocation("skibidi/background.png"));
        this.drawModalRectWithCustomSizedTexture(0, 0, 0, 0, this.width, this.height, this.width, this.height);
        GlStateManager.pushMatrix();
        GlStateManager.scale(2, 2, 2);
        this.drawCenteredString(mc.fontRendererObj, "Skibidi", this.width / 2 - 170, this.height / 2 - 120, -1);
